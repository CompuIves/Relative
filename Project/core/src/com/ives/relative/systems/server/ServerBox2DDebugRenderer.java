...
public class ServerBox2DDebugRenderer implements Disposable {
    ...
    public final Color UNIVERSE_BODY_COLOR = new Color(0.0f, 0, 0, 1);
    ...
    public ServerBox2DDebugRenderer() {
        this(true, true, false, true, false, true);
    }

    public ServerBox2DDebugRenderer(boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
    ...
    public static void setAxis(Vector2 axis) {
        ServerBox2DDebugRenderer.axis = axis;
    }
